...
class repartidor_model extends CI_Model
{
    ...
    public function registrar_repartidor($nombre,$usuario,$password,$correo)
    {
        ...
        $this->db->set('TB_PERFIL_ID', '5');
        $this->db->insert("tb_usuario");
        return $this->db->insert_id();
    }

    public function editar_repartidor($id, $usuario, $nombre, $correo, $password)
    {
        $this->db->set('USUARIO', $usuario);
        $this->db->set('NOMBRE', $nombre);
        $this->db->set('CORREO', $correo);
