...
<div class='row'>
    <div class='panel panel-primary'>
        ...
        <div class='panel-body'>
            <table id='tabla_estados_pedidos' class='table table-responsive'>
                <thead>
                <tr>
                    <th>ID</th>
                    <th>NOMBRE</th>
...
<div class='modal fade' id='modal_agregar_editar_estados_pedidos' role='dialog'>
    <div class='modal-dialog'>
        <div class='modal-content'>
            <div class='modal-header'>
                <button type='button' class='close' data-dismiss='modal'>&times;</button>
                <h4 class='modal-title' id='titulo_agregar_editar_estados_pedidos'></h4>
            </div>
